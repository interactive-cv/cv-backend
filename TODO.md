...
- [x] Админ-панель (UI) для управления откликами, CV и короткими ссылками из браузера
- [ ] Расширенная аналитика просмотров и переходов по коротким ссылкам
- [ ] **Напоминалка о собеседовании** — на основании `interview.scheduled_at`: уведомление (email/Telegram/push) перед предстоящим интервью
